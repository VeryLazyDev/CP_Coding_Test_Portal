...
export const UserLayout = PageLoader(
    lazy(() => import("@/features/user/layout/UserLayout.jsx")),
);
export const HomePage = PageLoader(
    lazy(() => import("@/features/user/pages/HomePage.jsx")),
);
export const AuthLayout = PageLoader(
    lazy(() => import("@/features/auth/layout/AuthLayout.jsx")),
);
export const LoginPage = PageLoader(
    lazy(() => import("@/features/auth/pages/LoginPage.jsx")),
);
